...
class SchemaGenerator {
    ...
    getTargetSchema() {
        ...
        return DatabaseSchema_1.DatabaseSchema.fromMetadata(metadata, this.platform, this.config);
    }
    async getCreateSchemaSQL(options = {}) {
        var _a;
        const wrap = (_a = options.wrap) !== null && _a !== void 0 ? _a : true;
    ...
    async dropSchema(options = {}) {
        var _a;
        options.wrap = (_a = options.wrap) !== null && _a !== void 0 ? _a : true;
        if (options.dropDb) {
    ...
    async getUpdateSchemaSQL(options = {}) {
        var _a, _b, _c, _d;
        const wrap = (_a = options.wrap) !== null && _a !== void 0 ? _a : true;
        options.safe = (_b = options.safe) !== null && _b !== void 0 ? _b : false;
        options.dropTables = (_c = options.dropTables) !== null && _c !== void 0 ? _c : true;
        const toSchema = this.getTargetSchema();
        const fromSchema = (_d = options.fromSchema) !== null && _d !== void 0 ? _d : await DatabaseSchema_1.DatabaseSchema.create(this.connection, this.platform, this.config);
    ...
    alterTable(diff, safe) {
        ...
        ret.push(this.knex.schema.alterTable(diff.name, table => {
            ...
            if ('changedComment' in diff) {
                table.comment((_a = diff.changedComment) !== null && _a !== void 0 ? _a : '');
            }
        }));
        return ret;
    }
    ...
    async execute(sql, options = {}) {
        var _a;
        options.wrap = (_a = options.wrap) !== null && _a !== void 0 ? _a : false;
    ...
    createIndex(table, index, tableName, createPrimary = false) {
    ...
    createForeignKeys(table, tableDef) {
        if (!this.helper.supportsSchemaConstraints()) {
            return;
        }
        for (const fk of Object.values(tableDef.getForeignKeys())) {
